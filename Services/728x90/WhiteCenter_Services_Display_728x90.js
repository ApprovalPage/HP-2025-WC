...
lib.ssMetadata = [
		{name:"WhiteCenter_Services_Display_728x90_atlas_P_1", frames: [[0,0,1320,270]]},
		{name:"WhiteCenter_Services_Display_728x90_atlas_NP_1", frames: [[0,0,320,440],[322,182,400,180],[322,0,460,180]]}
];
...
(lib._160x600grad = function() {
	this.initialize(ss["WhiteCenter_Services_Display_728x90_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib._728x90pic = function() {
	this.initialize(ss["WhiteCenter_Services_Display_728x90_atlas_NP_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
(lib.HealthPointLogo = function() {
	this.initialize(ss["WhiteCenter_Services_Display_728x90_atlas_P_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._728x90pic();
...
}).prototype = getMCSymbolPrototype(lib.PIC1, new cjs.Rectangle(-400,0,400,180), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#E87D1D").s().p("AAoBOIgKgcIg8AAIgKAcIgtAAIBBibIApAAIBBCbgAARARIgRgrIgRArIAiAAg");
...
// stage content:
(lib.WhiteCenter_Services_Display_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(1149.3,55.9,3.5424,3.5424,0,0,0,130.5,18.5);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({regX:130.7,scaleX:0.7085,scaleY:0.7085,x:456.5,y:22.45},13).wait(148));

	// dot
	this.instance_1 = new lib.dot();
	this.instance_1.setTransform(367.75,19,0.708,0.708,0,0,0,0.1,13.7);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(42).to({_off:false},0).wait(123));

	// B4_copy
	this.instance_2 = new lib.B4copy();
	this.instance_2.setTransform(481.2,55.9,3.5424,3.5424,0,0,0,130.5,18.5);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(32).to({_off:false},0).to({regX:130.7,scaleX:0.7085,scaleY:0.7085,x:456.5,y:22.45},13).wait(120));

	// B5
	this.instance_3 = new lib.B5();
	this.instance_3.setTransform(1103.55,55.9,3.5424,3.5424,0,0,0,130.5,18.5);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(51).to({_off:false},0).to({regX:130.7,scaleX:0.7085,scaleY:0.7085,x:456.5,y:40.6},13).wait(101));

	// dot_copy
	this.instance_4 = new lib.dot();
	this.instance_4.setTransform(407.25,36.5,0.708,0.708,0,0,0,0.1,13.7);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(72).to({_off:false},0).wait(93));

	// B5_copy
	this.instance_5 = new lib.B5copy();
	this.instance_5.setTransform(333.3,55.9,3.5424,3.5424,0,0,0,130.5,18.5);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(69).to({_off:false},0).to({regX:130.7,scaleX:0.7085,scaleY:0.7085,x:456.5,y:40.6},13).wait(83));

	// B6
	this.instance_6 = new lib.B6();
	this.instance_6.setTransform(1187.25,55.9,3.5424,3.5424,0,0,0,130.5,18.5);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(79).to({_off:false},0).to({regX:130.7,regY:18.6,scaleX:0.7085,scaleY:0.7085,x:456.5,y:58.85},13).wait(73));

	// dot_copy_copy
	this.instance_7 = new lib.dot();
	this.instance_7.setTransform(372.75,55,0.708,0.708,0,0,0,0.1,13.7);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(96).to({_off:false},0).wait(69));

	// B6_copy
	this.instance_8 = new lib.B6copy();
	this.instance_8.setTransform(426.35,55.9,3.5424,3.5424,0,0,0,130.5,18.5);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(86).to({_off:false},0).to({regX:130.7,regY:18.6,scaleX:0.7085,scaleY:0.7085,x:456.5,y:58.85},13).wait(66));

	// B7
	this.instance_9 = new lib.B7();
	this.instance_9.setTransform(826.1,55.9,3.5424,3.5424,0,0,0,130.5,18.5);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(94).to({_off:false},0).to({regX:130.7,scaleX:0.7085,scaleY:0.7085,x:412.5,y:76.95},15).wait(56));

	// B7_copy
	this.instance_10 = new lib.B7copy();
	this.instance_10.setTransform(826.1,-20.1,3.5424,3.5424,0,0,0,130.5,18.5);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(100).to({_off:false},0).to({regX:130.7,scaleX:0.7085,scaleY:0.7085,x:527.5,y:58.95},15).wait(50));

	// HEAD4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFAC8").s().p("AgsBFIAAiHIAvAAIAAAcQAMgfAeABIAAAyIgEAAQgmAAAAAtIAAAqg");
	this.shape_1.setTransform(173.525,73.6215);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFAC8").s().p("AgvA0QgUgVAAgfIAAAAQAAgdATgUQATgVAdAAQAhAAASAXQARATAAAfIAAAKIhaAAQAGAXAXAAQAPgBAPgOIAaAWQgWAcglAAQgfAAgUgTgAAYgKQgCgLgGgHQgGgHgKAAQgSAAgFAZIAvAAIAAAAg");
	this.shape_2.setTransform(160.525,73.75);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFAC8").s().p("AgZBJIAAARIgxAAIAAi2IAxAAIAABCQAQgWAXAAQAaAAAQATQASAUABAfIAAAAQgBAggSAUQgQATgaAAQgXAAgQgUgAgSAAQgJAIAAAOIAAAAQAAAOAJAIQAHAJALAAQALAAAJgJQAHgIABgOIAAAAQgBgOgHgIQgJgIgLAAQgLAAgHAIg");
	this.shape_3.setTransform(145.1,71.525);
	...
	this.shape_4.setTransform(124.675,73.575);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFAC8").s().p("AgvA0QgUgVAAgfIAAAAQAAgdATgUQATgVAdAAQAhAAASAXQARATAAAfIAAAKIhaAAQAGAXAXAAQAPgBAPgOIAaAWQgWAcglAAQgfAAgUgTgAAYgKQgCgLgGgHQgGgHgKAAQgSAAgFAZIAvAAIAAAAg");
	this.shape_5.setTransform(105.275,73.75);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFAC8").s().p("AgVBEIg2iHIAyAAIAZBOIAahOIAyAAIg3CHg");
	this.shape_6.setTransform(90.275,73.775);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFAC8").s().p("Ag1AyQgUgUgBgeIAAAAQABgdAUgUQAXgVAeAAQAhAAAUAVQAWAUAAAdIAAAAQAAAegWAUQgVAVggAAQgfAAgWgVgAgUgVQgIAJAAAMIAAAAQABANAHAIQAJAJALAAQANAAAIgJQAIgIAAgNIAAAAQgBgLgHgJQgJgKgMAAQgMAAgIAJg");
	this.shape_7.setTransform(74.6,73.75);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFAC8").s().p("AAoBXIhKheIAABeIgwAAIAAiuIAuAAIBGBcIAAhcIAxAAIAACug");
	this.shape_8.setTransform(56.975,71.75);
	...
	this.shape_9.setTransform(33.05,73.575);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFAC8").s().p("AgXBbIAAiGIAvAAIAACGgAgYg3IAAgjIAxAAIAAAjg");
	this.shape_10.setTransform(21.725,71.375);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFAC8").s().p("AgsBFIAAiHIAvAAIAAAcQAMgfAeABIAAAyIgEAAQgmAAAAAtIAAAqg");
	this.shape_11.setTransform(179.075,46.6215);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFAC8").s().p("AgvA0QgUgVAAgfIAAAAQAAgdATgUQATgVAdAAQAhAAASAXQARATAAAfIAAAKIhaAAQAGAXAXAAQAPgBAPgOIAaAWQgWAcglAAQgfAAgUgTgAAYgKQgCgLgGgHQgGgHgKAAQgSAAgFAZIAvAAIAAAAg");
	this.shape_12.setTransform(166.075,46.75);
	...
	this.shape_13.setTransform(153.35,45.175);
	...
	this.shape_14.setTransform(140.55,46.575);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFAC8").s().p("AgvA0QgUgVAAgfIAAAAQAAgdATgUQATgVAdAAQAhAAASAXQARATAAAfIAAAKIhaAAQAGAXAXAAQAPgBAPgOIAaAWQgWAcglAAQgfAAgUgTgAAYgKQgCgLgGgHQgGgHgKAAQgSAAgFAZIAvAAIAAAAg");
	this.shape_15.setTransform(125.375,46.75);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFAC8").s().p("Ag5BBQgagZAAgnIAAgBQAAgmAagZQAbgbAmAAQAwAAAbAlIglAcQgQgVgXAAQgQAAgMANQgMAOAAATIAAAAQAAAUAMANQAMAOAQAAQAXgBARgUIAlAZQgdAogxAAQglAAgagag");
	this.shape_16.setTransform(109.25,44.75);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFAC8").s().p("AgvA0QgUgVAAgfIAAAAQAAgdATgUQATgVAdAAQAhAAASAXQARATAAAfIAAAKIhaAAQAGAXAXAAQAPgBAPgOIAaAWQgWAcglAAQgfAAgUgTgAAYgKQgCgLgGgHQgGgHgKAAQgSAAgFAZIAvAAIAAAAg");
	this.shape_17.setTransform(86.125,46.75);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFAC8").s().p("AgeApIAAg2IgQAAIAAgmIAQAAIAAgiIAuAAIAAAiIAfAAIAAAmIgfAAIAAAtQAAAOANAAQAIAAAKgFIAAAlQgPAIgSAAQgsAAAAgtg");
	this.shape_18.setTransform(73.4,45.175);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFAC8").s().p("AgXBbIAAiGIAvAAIAACGgAgYg3IAAgjIAxAAIAAAjg");
	this.shape_19.setTransform(64.775,44.375);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFAC8").s().p("AAUBbIAAhJQAAgWgUAAQgHAAgFAFQgGAGAAALIAABJIgwAAIAAi1IAwAAIAABCQAQgWAXAAQAWAAAMANQAMAOAAAWIAABYg");
	this.shape_20.setTransform(53.45,44.375);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFAC8").s().p("AAjBYIgjhjIgiBjIgqAAIg7ivIAzAAIAfBlIAihlIAoAAIAiBlIAehlIAzAAIg7Cvg");
	this.shape_21.setTransform(31.925,44.775);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFAC8").s().p("Ag0AyQgWgUAAgeIAAAAQAAgdAWgUQAVgVAgAAQAfAAAWAVQAUAUAAAdIAAAAQAAAegUAUQgWAVggAAQgfAAgVgVgAgUgVQgIAJABAMIAAAAQAAANAHAIQAJAJAMAAQAMAAAIgJQAHgIABgNIAAAAQAAgLgJgJQgIgKgMAAQgMAAgIAJg");
	this.shape_22.setTransform(140.15,19.75);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFAC8").s().p("AgeApIAAg2IgRAAIAAgmIARAAIAAgiIAuAAIAAAiIAgAAIAAAmIggAAIAAAtQAAAOANAAQAIAAAKgFIAAAlQgOAIgTAAQgsAAAAgtg");
	this.shape_23.setTransform(126.8,18.175);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFAC8").s().p("AhFBKIAPggQAXANAYAAQAjAAAAghIAAgFQgSAUgXAAQgZAAgSgRQgRgRgBgbIAAgBQABgcARgTQARgQAZAAQAXgBASAUIAAgQIAwAAIAABlQAAAmgSAQQgTAUgogBQglAAgegPgAgTgsQgIAIAAALIAAABQAAALAIAHQAIAHALAAQAMAAAIgHQAIgIAAgKIAAgBQAAgLgIgIQgIgIgMABQgLgBgIAIg");
	this.shape_24.setTransform(106.65,21.6);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFAC8").s().p("AAUBFIAAhIQAAgXgTAAQgIAAgGAGQgFAGAAALIAABIIgwAAIAAiGIAwAAIAAATQARgWAWAAQAWAAAMANQAMAOAAAXIAABXg");
	this.shape_25.setTransform(90.9,19.575);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFAC8").s().p("AgXBbIAAiGIAvAAIAACGgAgYg3IAAgjIAxAAIAAAjg");
	this.shape_26.setTransform(79.575,17.375);
	...
	this.shape_27.setTransform(64.075,19.575);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FFFAC8").s().p("Ag0AyQgWgUABgeIAAAAQgBgdAWgUQAWgVAeAAQAgAAAWAVQAUAUAAAdIAAAAQAAAegUAUQgWAVggAAQgfAAgVgVgAgUgVQgHAJAAAMIAAAAQgBANAJAIQAIAJALAAQANAAAIgJQAHgIAAgNIAAAAQABgLgJgJQgIgKgMAAQgMAAgIAJg");
	this.shape_28.setTransform(44.05,19.75);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFAC8").s().p("Ag5BBQgZgZAAgnIAAgBQAAgmAZgZQAbgbAnAAQAvAAAaAlIgkAcQgRgVgVAAQgSAAgMANQgLAOAAATIAAAAQAAAUALANQAMAOASAAQAWgBARgUIAkAZQgcAogwAAQgmAAgagag");
	this.shape_29.setTransform(27.3,17.75);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1}]}).wait(165));

	// BKGD_green
	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#8D8B00").s().p("AvnHCIAAuDIfPAAIAAODg");
	this.shape_30.setTransform(100,45);

	this.timeline.addTween(cjs.Tween.get(this.shape_30).wait(165));

	// SHAD_left
	this.instance_11 = new lib.SHAD();
	this.instance_11.setTransform(-99.4,221.95,1,1,89.9948,0,0,150,100);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(165));

	// LOGO
	this.instance_12 = new lib.HPlogowTag();
	this.instance_12.setTransform(858.35,39.8,0.68,0.68,0,0,0,0.2,0);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(139).to({_off:false},0).to({x:627.35},20,cjs.Ease.quintOut).wait(6));

	// POLY
	this.instance_13 = new lib.POLY();
	this.instance_13.setTransform(959,-50,1,1,0,0,0,0,-50);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(139).to({_off:false},0).to({x:728},20,cjs.Ease.quintOut).wait(6));

	// PIC1
	this.instance_14 = new lib.PIC1();
	this.instance_14.setTransform(628.05,45,0.5,0.5,0,0,0,-199.9,90);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(119).to({x:848.05},20,cjs.Ease.quintIn).to({_off:true},1).wait(25));

	// SHAD_right
	this.instance_15 = new lib.SHAD();
	this.instance_15.setTransform(827.9,-117.1,1,1,-89.9948,0,0,150,100);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(119).to({x:1047.9},20,cjs.Ease.quintIn).to({_off:true},1).wait(25));

	// BKGD
	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#FFFBCA").s().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	this.shape_31.setTransform(364,45);

	this.timeline.addTween(cjs.Tween.get(this.shape_31).wait(165));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-125.2,-82.2,1342.4,314.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/WhiteCenter_Services_Display_728x90_atlas_P_1.png", id:"WhiteCenter_Services_Display_728x90_atlas_P_1"},
		{src:"images/WhiteCenter_Services_Display_728x90_atlas_NP_1.jpg", id:"WhiteCenter_Services_Display_728x90_atlas_NP_1"}
	],
	preloads: []
};
