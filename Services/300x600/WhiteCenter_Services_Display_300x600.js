...
lib.ssMetadata = [
		{name:"WhiteCenter_Services_Display_300x600_atlas_P_1", frames: [[0,0,1320,270]]},
		{name:"WhiteCenter_Services_Display_300x600_atlas_NP_1", frames: [[0,0,600,400],[0,402,600,360],[0,764,600,360]]}
];
...
(lib._300x600grad = function() {
	this.initialize(ss["WhiteCenter_Services_Display_300x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
(lib.HealthPointLogo = function() {
	this.initialize(ss["WhiteCenter_Services_Display_300x600_atlas_P_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
// stage content:
(lib.WhiteCenter_Services_Display_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// border
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#8D8B00").ss(1,1,0,3).p("EgXWguyMAutAAAMAAABdlMgutAAAg");
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(29).to({_off:false},0).to({regX:130.6,scaleX:1.09,scaleY:1.09,x:292.25,y:206.15},7).wait(187));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(51).to({_off:false},0).to({regX:130.6,scaleX:1.09,scaleY:1.09,x:292.25,y:234.1},7).wait(165));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(64).to({_off:false},0).to({regX:130.6,scaleX:1.09,scaleY:1.09,x:292.25,y:262.05},7).wait(152));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(73).to({_off:false},0).to({regX:130.6,scaleX:1.09,scaleY:1.09,x:292.25,y:290},7).wait(143));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(82).to({_off:false},0).to({regX:130.6,scaleX:1.09,scaleY:1.09,x:292.25,y:317.95},7).wait(134));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(91).to({_off:false},0).to({regX:130.6,scaleX:1.09,scaleY:1.09,x:292.25,y:345.9},7).wait(125));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(100).to({_off:false},0).to({regX:130.6,scaleX:1.09,scaleY:1.09,x:292.25,y:373.85},7).wait(116));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_30).wait(223));

	// SHAD_top
	this.instance_7 = new lib.SHAD();
	this.instance_7.setTransform(150,84,1,1,180,0,0,150,100);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(223));

	// PIC2
	this.instance_8 = new lib.PIC2();
	this.instance_8.setTransform(150,510,1,1,0,0,0,150,-90);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(119).to({y:710},10,cjs.Ease.quintIn).wait(94));

	// SHAD_bottom
	this.instance_9 = new lib.SHAD();
	this.instance_9.setTransform(150,500,1,1,0,0,0,150,100);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(120).to({y:500.15,alpha:0.9167},0).wait(1).to({y:500.4,alpha:0.8333},0).wait(1).to({y:500.85,alpha:0.75},0).wait(1).to({y:501.85,alpha:0.6667},0).wait(1).to({y:504.8,alpha:0.5833},0).wait(1).to({y:515.55,alpha:0.5},0).to({_off:true},1).wait(97));

	// LOGO
	this.instance_10 = new lib.HPlogowTag();
	this.instance_10.setTransform(149.25,512.05);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(119).to({_off:false},0).wait(104));

	// POLY
	this.instance_11 = new lib.Tween3("synched",0);
	this.instance_11.setTransform(150,510);
	this.instance_11._off = true;

	this.instance_12 = new lib.Tween4("synched",0);
	this.instance_12.setTransform(150,510);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_11}]},119).to({state:[{t:this.instance_12}]},10).wait(94));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(119).to({_off:false},0).to({_off:true},10,cjs.Ease.quintOut).wait(94));

	// BKGD
	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#FFFBCA").s().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");
	this.shape_31.setTransform(150,300);

	this.timeline.addTween(cjs.Tween.get(this.shape_31).wait(223));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-624.6,284,1699.1999999999998,516);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/WhiteCenter_Services_Display_300x600_atlas_P_1.png", id:"WhiteCenter_Services_Display_300x600_atlas_P_1"},
		{src:"images/WhiteCenter_Services_Display_300x600_atlas_NP_1.jpg", id:"WhiteCenter_Services_Display_300x600_atlas_NP_1"}
	],
	preloads: []
};
