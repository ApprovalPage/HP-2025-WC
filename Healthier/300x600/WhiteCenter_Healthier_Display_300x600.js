...
lib.ssMetadata = [
		{name:"WhiteCenter_Healthier_Display_300x600_atlas_P_1", frames: [[0,0,1320,270]]},
		{name:"WhiteCenter_Healthier_Display_300x600_atlas_NP_1", frames: [[602,0,600,400],[1204,0,600,360],[1204,362,600,360],[0,0,600,600],[602,402,600,360]]}
];
...
(lib._300x600grad = function() {
	this.initialize(ss["WhiteCenter_Healthier_Display_300x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
(lib.HealthPointLogo = function() {
	this.initialize(ss["WhiteCenter_Healthier_Display_300x600_atlas_P_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
// stage content:
(lib.WhiteCenter_Healthier_Display_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/WhiteCenter_Healthier_Display_300x600_atlas_P_1.png", id:"WhiteCenter_Healthier_Display_300x600_atlas_P_1"},
		{src:"images/WhiteCenter_Healthier_Display_300x600_atlas_NP_1.jpg", id:"WhiteCenter_Healthier_Display_300x600_atlas_NP_1"}
	],
	preloads: []
};
