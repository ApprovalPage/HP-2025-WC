...
lib.ssMetadata = [
		...
		{name:"WhiteCenter_Display_300x600_atlas_NP_1", frames: [[0,0,600,400],[0,402,600,360],[0,764,600,360],[0,1126,600,360],[0,1488,600,360]]}
];
...
}).prototype = getMCSymbolPrototype(lib.PIC3, new cjs.Rectangle(0,-180,300,180), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(109).to({_off:false},0).to({y:510},10,cjs.Ease.quintOut).to({_off:true},60).wait(91));

	// mask_idn (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");
	var mask_graphics_119 = new cjs.Graphics().p("ArtJYIAAyvIXbAAIAASvg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:150,y:300}).wait(119).to({graphics:mask_graphics_119,x:225,y:360}).wait(60).to({graphics:null,x:0,y:0}).wait(91));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(49).to({_off:false},0).to({x:150},10,cjs.Ease.quintOut).wait(60).to({regX:150.1,scaleX:0.6666,scaleY:0.6666,x:242.2,y:482},0).to({y:359.95},10,cjs.Ease.quintOut).to({_off:true},50).wait(91));

	// mask_idn (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");
	var mask_1_graphics_119 = new cjs.Graphics().p("ArtJYIAAyvIXbAAIAASvg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:150,y:300}).wait(60).to({graphics:null,x:0,y:0}).wait(59).to({graphics:mask_1_graphics_119,x:75,y:360}).wait(60).to({graphics:null,x:0,y:0}).wait(91));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(49).to({x:450},10,cjs.Ease.quintOut).to({_off:true},1).wait(59).to({_off:false,regX:149.9,regY:-89.9,scaleX:0.6667,scaleY:0.6667,x:93.95,y:482.05},0).to({y:360.05},10,cjs.Ease.quintOut).to({_off:true},50).wait(91));

	// SHAD
	this.instance_17 = new lib.SHAD();
	this.instance_17.setTransform(150,500,1,1,0,0,0,150,100);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(119).to({y:380},10,cjs.Ease.quintOut).wait(50).to({rotation:180,y:84},0).wait(91));
